...
from video_generator import build_kids_video
from youtube_uploader import get_youtube_service, upload_short
...
KIDS_TOPICS = [
    {
        ...
        "tags": ["science", "kids science", "why is the sky blue", "fun facts", "educational"]
    },
    {
    ...
    if gemini_key:
        try:
            ...
            prompt = (
                ...
                "and 'tags' (a list of 5 tags). Do not output markdown wrapper."
            )
